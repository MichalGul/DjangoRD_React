...
SECRET_KEY = 'n-(-t$4lcb57f7-q5*m^n-86jvftssn8hddxie==t9x37%#zv#'
...
# Ustawienia web json token
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=5),
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),
    'ROTATE_REFRESH_TOKENS': False, #Tworzy nowe tokeny gdy wyslana jest prosba o token
    'BLACKLIST_AFTER_ROTATION': True, #blokowanie wykorzystanych tokenow
